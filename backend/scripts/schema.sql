...
-- FK for conversations.last_message_id
...
-- ============================================
CREATE OR REPLACE FUNCTION increment_field(p_table TEXT, p_id UUID, p_field TEXT, p_amount NUMERIC)
RETURNS VOID AS $$
BEGIN
...
-- ============================================
-- RLS: Allow all operations (Express handles auth via JWT)
-- ============================================
DO $$
DECLARE
    t TEXT;
